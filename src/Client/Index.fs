                      ...
                      prop.children [
                          Html.tbody [
                              Html.tr [
                                  ...
                                  Html.td (sprintf "%.2f" weatherReport.AverageTemperature)
                              ]
                          ]
                      ]
                  ]
                    ...
                    Bulma.navbarItem.div [
                        Bulma.title [
                            Bulma.icon [
                                ...
                                prop.children [
                                    Html.i [
                                        prop.className "fas fa-unlock-alt"
                                    ]
                                ]
                            ]
                            Html.span [
...
let view (model: Model) dispatch =
    Html.div [
        prop.style [
            style.backgroundColor "#eeeeee57"
                    ...
                    Bulma.field.div [
                        ...
                        prop.children [
                            ...
                            Bulma.control.div [
                                Bulma.button.a [
                                    color.isPrimary
                                    prop.onClick (fun _ -> dispatch PostcodeCleared)
                                    prop.disabled (model.Postcode = "")
                                    prop.text "Clear"
                                ]
                            ]
                        ]
                            ...
                            prop.children [
                                Bulma.columns [
                                    Bulma.column [
                                        ...
                                        prop.children [ locationWidget report ]
                                    ]
                                    Bulma.column [
